    ...
    <div id="Container_testimoniosLE">
        <div id="testimoniosLE">
            <div class="title_Testimonios">
                <h1>Testimonios de Legado Educativo</h1>
            </div>
            <div id="Container_Slider_Testimonios">
                <div id="Slider_Testimonios">
                    <div class="Container_Btn_Testimonios">
                        <asp:Button ID="Btn_AnteriorTesti" runat="server" Text="" CssClass="Btn_Testimonios Btn_AnteriorTesti" OnClick="Btn_AnteriorTesti_Click" />
                    </div>
                    <div id="Container_card_Testimonios">
                        <div class="ImgTesti">
                            <img src="Resources/51408936851_9cd8fc30a9_k.jpg" />
                        </div>
                        <div class="card_02"></div>
            ...
            <div id="container_VideoTesti">
                ...
                <div class="video">
                    <video src="Resources/Copia_de_Testimonio_Luis_Meneses.mp4" controls></video>
                </div>
            </div>
        </div>
    </div>
